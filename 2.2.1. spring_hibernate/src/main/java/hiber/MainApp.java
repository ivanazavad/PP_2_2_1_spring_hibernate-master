...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      for (User user : users) {
       ...
       System.out.println(userService.findUserWithCar("Car1", 1));
       System.out.println(userService.findUserWithCar("Car2", 2));
       System.out.println(userService.findUserWithCar("Car3", 3));
